        ...
        errors.append(
            {
                ...
                "code": exc["code"],
                "field": ".".join(
                    map(str, path)) or api_settings.NON_FIELD_ERRORS_KEY,
            }
        )
...
def exception_handler(exc: Exception, context: dict) -> Optional[
    response.Response]:
    """
    ...
    if isinstance(exc, exceptions.APIException):
        ...
        data = {"errors": [{"code": "not_found", "message": "Not found.",
